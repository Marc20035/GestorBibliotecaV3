...
import io.bootify.gestor_biblioteca_v3.service.LectorService;
import io.bootify.gestor_biblioteca_v3.util.CustomCollectors;
...
public class LectorController {
    ...
    public void prepareContext(final Model model) {
        model.addAttribute("prestamosValues", prestamoRepository.findAll(Sort.by("id"))
                .stream()
